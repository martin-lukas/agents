---
name: git-push
description: Commit and push project changes (source code, not .planning/ files).
---
...
2. Exclude `.planning/` files - they have their own `gsd-push` skill.
...
**With amend argument** (if specified by user):
